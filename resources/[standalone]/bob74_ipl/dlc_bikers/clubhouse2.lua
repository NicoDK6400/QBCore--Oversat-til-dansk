...
BikerClubhouse2 = {
    ...
    LoadDefault = function()
        ...
        BikerClubhouse2.Mural.Set(BikerClubhouse2.Mural.graffitis)
        ...
        BikerClubhouse2.Weed.Set(BikerClubhouse2.Weed.stage1)
        BikerClubhouse2.Counterfeit.Set(BikerClubhouse2.Counterfeit.stage1)
        BikerClubhouse2.Documents.Set(BikerClubhouse2.Documents.stage1)
