...
RegisterNetEvent('qb-diving:client:SetDivingLocation', function(DivingLocation)
    ...
    CreateThread(function()
        ...
        AddTextComponentSubstringPlayerName('Dykker område')
...
RegisterNetEvent('qb-diving:server:CallCops', function(Coords, msg)
    ...
    BeginTextCommandSetBlipName('STRING')
    AddTextComponentString("112 - Dykker område")
...
RegisterNetEvent('qb-diving:client:UseGear', function(bool)
    if bool then
        ...
        if currentGear.enabled then
            GearAnim()
            QBCore.Functions.Progressbar("remove_gear", "Tager dykkerdrgt på...", 5000, false, true, {}, {}, {}, {}, function() -- Done
                DeleteGear()
            ...
            QBCore.Functions.Notify('Du har ikke en dykkerdragt på', 'error')
        end
    end
end)
