...
AddEventHandler('prison:client:Enter', function(time)
	...
	QBCore.Functions.Notify("POLITI: Din ejendom er beslaglagt. Du får alt tilbage, når din tid er ovre..", "error", 5000)
	DoScreenFadeOut(500)
...
AddEventHandler('prison:client:Leave', function()
	if jailTime > 0 then 
		...
		QBCore.Functions.Notify("POLITI: Du modtog din ejendom igen!", "success", 5000)
		inJail = false
		RemoveBlip(currentBlip)
