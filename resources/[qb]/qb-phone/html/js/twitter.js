...
QB.Phone.Notifications.LoadTweets = function (Tweets) {
    ...
    if (Tweets !== null && Tweets !== undefined && Tweets !== "" && Tweets.length > 0) {
        ...
        let html = `<div class="twitter-no-tweets"><p>Ingen tweets :(</p></div>`
...
$(document).on('click', '#send-tweet', function (e) {
    ...
    if (TweetMessage != "" || TweetUrl != "") {
        ...
        QB.Phone.Notifications.Add("fab fa-twitter", "Twitter", "Skriv en besked!", "#1DA1F2");
    }
});
    ...
    if (hashtags !== null) {
        ...
        $.each(hashtags, function (i, hashtag) {
            ...
            if (hashtag.messages.length >= MinimumTrending) {
                Elem = '<div class="twitter-hashtag" id="tag-' + hashtag.hashtag + '"><div class="twitter-hashtag-status">Populært i byen</div> <div class="twitter-hashtag-tag">#' + hashtag.hashtag + '</div> <div class="twitter-hashtag-messages">' + hashtag.messages.length + ' ' + TweetHandle + '</div> </div>';
            } else {
                Elem = '<div class="twitter-hashtag" id="tag-' + hashtag.hashtag + '"><div class="twitter-hashtag-status">Ikke populært i byen</div> <div class="twitter-hashtag-tag">#' + hashtag.hashtag + '</div> <div class="twitter-hashtag-messages">' + hashtag.messages.length + ' ' + TweetHandle + '</div> </div>';
            }
