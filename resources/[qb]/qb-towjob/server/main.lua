...
RegisterNetEvent('qb-tow:server:DoBail', function(bool, vehInfo)
    ...
    if bool then
        ...
        if Bail[Player.PlayerData.citizenid] ~= nil then
            ...
            TriggerClientEvent('QBCore:Notify', src, 'Du fik: '..Config.BailPrice..' DKK tilbage fra depositum', 'success')
        end
    end
end)
...
RegisterNetEvent('qb-tow:server:11101110', function(drops)
    ...
    TriggerClientEvent('chatMessage', source, "JOB", "warning", "Du har modtaget en løn: "..payment.." DKK, Brutto: "..price.." DKK (hvoraf "..bonus.." DKK er Bonus) i "..taxAmount.." DKK Moms ("..PaymentTax.."%)")
end)

QBCore.Commands.Add("npc", "Start et NPC job", {}, false, function(source, args)
