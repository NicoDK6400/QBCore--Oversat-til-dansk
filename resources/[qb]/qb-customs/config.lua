...
vehicleCustomisation = {
    ...
    {category = "Bagerste kofanger", id = 2},
    {category = "Sideskørt", id = 3},
    {category = "Udstødning", id = 4},
    {category = "Roll Cage", id = 5},
    {category = "Køler", id = 6},
    {category = "Motorhjelm", id = 7},
    {category = "Venstre skærm", id = 8},
    {category = "Højre skærm", id = 9},
    {category = "Tag",id = 10},
    {category = "Motor upgrade", id = 11},
    {category = "Bremser upgrade", id = 12},
    {category = "Gearkasse upgrade", id = 13},
    {category = "Støddæmpere upgrade", id = 15},
    {category = "Karosseri upgrade", id = 16},
    {category = "Turbo upgrade", id = 18},
    {category = "Personlige plader",id = 25},
    {category = "Trim A", id = 27},
    {category = "Mønstre", id = 28},
    {category = "Dashboard", id = 29},
    {category = "Dial", id = 30},
    {category = "Dør højtalere", id = 31},
    {category = "Sæder", id = 32},
    {category = "Rat", id = 33},
    {category = "Gearstang", id = 34},
    {category = "Plakater", id = 35},
    {category = "Højtalere", id = 36},
    {category = "Baggagerum", id = 37},
    {category = "Hydraulik", id = 38},
    {category = "Motor block", id = 39},
    {category = "Luftfilter", id = 40},
    {category = "Strut", id = 41},
    {category = "Arch Cover", id = 42},
    {category = "Aerial", id = 43},
    {category = "Trim B", id = 44},
    {category = "Brændstofstank", id = 45},
